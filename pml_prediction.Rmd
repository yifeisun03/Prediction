...
## Data explore
###read in data and clean up variable with too much empty entry and low variability.
```{r Data clean}
# read in data
...
```
result:
* Pre-processing with PCA increase the computing time but not improving the accuracy
* Random forest with cross validation yield the best result from the selected testing models
